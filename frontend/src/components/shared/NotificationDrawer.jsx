      ...
      <Drawer>
        <DrawerTrigger>
          <div className=" relative mr-2">
            {noteCounter ? (
              <span className=" absolute z-30 bg-primary-light   -right-2  text-white size-5  flex   font-medium  justify-center items-center rounded-full p-2 ">
                {noteCounter}
              </span>
            ) : (
              ""
        ...
        <DrawerContent>
          <ScrollArea className="h-[70vh] border-b-2 border-gray-400 rounded-b-xl">
            {data.length ? (
                  ...
                  return (
                    <div key={id}>
                      <div
                        ...
                        className={cn(
                          "flex   hover:bg-blue-100  relative items-center justify-between w-full p-1 rounded",
                          is_seen ? "" : "bg-gray-50"
                        )}
                      >
                        {!is_seen && (
                          <span className=" absolute  size-2  bg-primary-light rounded-full right-0 top-0">
                            {" "}
                          </span>
                        )}
                        <div>
              ...
              <div className="text-xl text-gray-700 font-bold flex justify-center items-center mt-8">
